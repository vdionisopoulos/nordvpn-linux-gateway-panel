...
Το δημόσιο screenshot είναι redacted και δεν περιλαμβάνει credentials, public IP ή στοιχεία ταυτοποίησης ιδιωτικών συσκευών.

## Τεκμηρίωση έργου

- [Wiki](../../wiki)
- [Ελληνικό roadmap](ROADMAP.el.md)
- [Αγγλικό roadmap](ROADMAP.md)
- [Fail-closed DNS design](docs/dns.md)
- [NordVPN authentication και secret handling](docs/nordvpn-authentication.md)
...
Όταν το NordVPN αναφέρει ήδη `Connected`, το smoke test περιμένει έως 30 δευτερόλεπτα ώστε η managed default route και το gateway heartbeat να φτάσουν σε σταθερή healthy κατάσταση πριν ξεκινήσουν οι αρχικοί έλεγχοι. Για ιδιαίτερα αργό host μπορείς να ορίσεις `VPN_SMOKE_CONVERGENCE_TIMEOUT=<δευτερόλεπτα>`.
...
Το [CHANGELOG.md](CHANGELOG.md) περιγράφει τις εκδόσεις και το [stable release checklist](docs/release-checklist.md) τα απαιτούμενα release gates. Ένα tag που συμφωνεί με το `VERSION`, όπως `v1.0.3`, ενεργοποιεί workflow που επαναλαμβάνει τους ελέγχους και δημιουργεί ZIP, tar.gz και SHA-256 checksums.
