...
Το στιγμιότυπο έχει καλυμμένα τα ευαίσθητα στοιχεία για δημόσια χρήση. Το εγκατεστημένο panel υποστηρίζει Ελληνικά και Αγγλικά μέσω των επιλογών `ΕΛ` / `EN`.
...
Το CI ελέγχει επίσης release metadata, Bash/ShellCheck, nftables και systemd units.

## Releases

Το [CHANGELOG.md](CHANGELOG.md) περιγράφει τις εκδόσεις. Tag που συμφωνεί με το `VERSION`, όπως `v1.0.3`, ενεργοποιεί το validated release workflow, δημιουργεί ZIP, tar.gz και SHA-256 checksums και ορίζει το release ως latest.
